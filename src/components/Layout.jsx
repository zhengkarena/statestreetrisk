          ...
          {tabs.map((t) => {
            ...
            return (
              <button
                ...
                className={
                  'w-full flex items-center justify-between gap-2 px-3 py-2 rounded text-left text-sm transition-colors ' +
                  (isActive
              ...
              >
                ...
                <span
                  className={
                    ...
                    (isActive ? 'bg-navy-500 text-white' : 'bg-navy-800 text-navy-300')
                  }
                >
                  {t.milestone}
                </span>
